...
class TestKuhn(unittest.TestCase):
    ...
    def test_equilibrium_value(self):
        ...
        assert abs(self.kuhn.profile_value(strategy_p1, strategy_p2)[0] + 0.0555555555) < self.tolerance
    ...
    def test_raise_call_value(self):
        ...
        assert abs(self.kuhn.profile_value(strategy_p1, strategy_p2)[0]) < self.tolerance
