...
files = '"leduc_5_rtcfr_plus_adp.txt" \
         "leduc_5_rtcfr_plus_1e-1.txt" \
         "leduc_5_rtcfr_plus_1e-2.txt" \
         "leduc_5_rtcfr_plus_1e-3.txt" \
         "leduc_5_rtcfr_plus_0.txt" \
         "leduc_5_cfr_plus_1e-3.txt" \
         "leduc_5_cfr_plus_0.txt" \
         "leduc_5_egt_1e-3.txt" \
         "leduc_5_egt_0.txt" \
         "leduc_5_regomwu_0.txt" \
         "leduc_5_regomwu_1e-3.txt" \
         "leduc_5_regomwu_efpe_adp.txt"'
...
# Plot exploitability
set output 'leduc-5-exp-full.png'
...
set output 'leduc-5-max-regret-full.png'
