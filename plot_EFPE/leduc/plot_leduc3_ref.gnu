...
files = '"leduc_3_rtcfr_plus_adp.txt" \
         "leduc_3_rtcfr_plus_1e-1.txt" \
         "leduc_3_rtcfr_plus_1e-2.txt" \
         "leduc_3_rtcfr_plus_1e-3.txt" \
         "leduc_3_rtcfr_plus_0.txt" \
         "leduc_3_cfr_plus_1e-3.txt" \
         "leduc_3_cfr_plus_0.txt" \
         "leduc_3_egt_1e-3.txt" \
         "leduc_3_egt_0.txt" \
         "leduc_3_regomwu_0.txt" \
         "leduc_3_regomwu_1e-3.txt" \
         "leduc_3_regomwu_efpe_adp.txt"'
...
# Plot exploitability
set output 'leduc-3-exp-full.png'
...
set output 'leduc-3-max-regret-full.png'
