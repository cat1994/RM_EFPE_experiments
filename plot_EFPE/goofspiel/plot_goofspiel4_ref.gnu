...
files = '"goofspiel_4_rtcfr_plus_adp.txt" \
         "goofspiel_4_rtcfr_plus_1e-1.txt" \
         "goofspiel_4_rtcfr_plus_1e-2.txt" \
         "goofspiel_4_rtcfr_plus_1e-3.txt" \
         "goofspiel_4_rtcfr_plus_0.txt" \
         "goofspiel_4_cfr_plus_1e-3.txt" \
         "goofspiel_4_cfr_plus_0.txt" \
         "goofspiel_4_egt_1e-3.txt" \
         "goofspiel_4_egt_0.txt" \
         "goofspiel_4_regomwu_0.txt" \
         "goofspiel_4_regomwu_1e-3.txt" \
         "goofspiel_4_regomwu_efpe_adp.txt"'
...
# Plot exploitability
set output 'goofspiel-4-exp-full.png'
...
set output 'goofspiel-4-max-regret-full.png'
