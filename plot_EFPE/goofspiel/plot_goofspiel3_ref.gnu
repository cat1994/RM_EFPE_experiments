...
files = "\
  'goofspiel_3_rtcfr_plus_adp.txt' \
  'goofspiel_3_rtcfr_plus_1e-1.txt' \
  'goofspiel_3_rtcfr_plus_1e-2.txt' \
  'goofspiel_3_rtcfr_plus_1e-3.txt' \
  'goofspiel_3_rtcfr_plus_0.txt' \
  'goofspiel_3_cfr_plus_1e-3.txt' \
  'goofspiel_3_cfr_plus_0.txt' \
  'goofspiel_3_egt_1e-3.txt' \
  'goofspiel_3_egt_0.txt' \
  'goofspiel_3_regomwu_0.txt' \
  'goofspiel_3_regomwu_1e-3.txt' \
  'goofspiel_3_regomwu_efpe_adp.txt' \
"
...
# Plot exploitability
set output 'goofspiel-3-exp-full.png'
...
set output 'goofspiel-3-max-regret-full.png'
