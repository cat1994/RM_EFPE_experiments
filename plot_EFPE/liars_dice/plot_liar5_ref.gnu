...
files = '"liars_dice_5_rtcfr_plus_adp.txt" \
         "liars_dice_5_rtcfr_plus_1e-1.txt" \
         "liars_dice_5_rtcfr_plus_1e-2.txt" \
         "liars_dice_5_rtcfr_plus_1e-3.txt" \
         "liars_dice_5_rtcfr_plus_0.txt" \
         "liars_dice_5_cfr_plus_1e-3.txt" \
         "liars_dice_5_cfr_plus_0.txt" \
         "liars_dice_5_egt_1e-3.txt" \
         "liars_dice_5_egt_0.txt" \
         "liars_dice_5_regomwu_0.txt" \
         "liars_dice_5_regomwu_1e-3.txt" \
         "liars_dice_5_regomwu_efpe_adp.txt"'
...
# Plot exploitability
set output 'liars_dice-5-exp-full.png'
...
set output 'liars_dice-5-max-regret-full.png'
